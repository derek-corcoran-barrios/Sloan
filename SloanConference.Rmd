...
system.time(for (i in 1:length(Offensive_teams)) {
  ...
  for (j in 1:length(defenseve_names)){
    df[j,i] <- ShotComparison(OffTeam = Offensive_team, DefTown =                        defenseve_names[j], SeasondataOff = shotDataTotal2016, SeasonDataDef = shotDatafDef2016, nbins = 30)
  }
})
